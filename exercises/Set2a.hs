...
addEithers a b = addEithersHelper a b
    where 
        addEithersHelper (Right a') (Right b') = Right (a' + b')
        addEithersHelper (Right _) (Left b') = Left b'
        addEithersHelper (Left a') _ = Left a'
